  ...
  if($filename[1] == 'csv')
  {
   ...
   while($data = fgetcsv($handle))
   {
	if ($i>0) {
		...
		$specialite = mysqli_real_escape_string($connect,$data[2]);
		$query = "INSERT into Medecin(NumMed,Nom,Specialite) values('$nummed','$nom','$specialite')";
...
<title>Database Query - Physician</title>
</head>
<body>

<h1>Database Query - Physician Table</h1>
