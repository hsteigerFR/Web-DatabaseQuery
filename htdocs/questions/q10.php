...
$sql='SELECT * FROM Service WHERE NumService NOT IN (SELECT NumService FROM Service NATURAL JOIN Acte WHERE NumPat IN (SELECT DISTINCT NumPat FROM Hospitalisation))';
...
<html>
<head>
	<title>Database Query - Q10</title>
</head>
<body>
</body>
</html>