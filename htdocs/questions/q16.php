...
$sql='SELECT DISTINCT Prenom FROM (Patient NATURAL JOIN Hospitalisation) JOIN Service ON Hospitalisation.NumService = Service.NumService WHERE Batiment = "B"';
...
<html>
<head>
	<title>Database Query - Q16</title>
</head>
<body>
</body>
</html>