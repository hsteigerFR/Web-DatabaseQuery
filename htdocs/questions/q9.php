...
$sql='SELECT DISTINCT NumPat, Nom, Prenom, Mutuelle FROM Patient NATURAL JOIN Acte WHERE NumPat NOT IN (SELECT DISTINCT NumPat FROM Hospitalisation)';
