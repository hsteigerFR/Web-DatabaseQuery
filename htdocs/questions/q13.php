...
$sql='SELECT NumPat, Nom, Prenom, Mutuelle FROM Patient NATURAL JOIN Hospitalisation WHERE Mutuelle <> "MUT" AND DateSortie > DATE_ADD(DateEntree, INTERVAL 3 DAY)';
...
<html>
<head>
	<title>Database Query - Q13</title>
</head>
<body>
</body>
</html>