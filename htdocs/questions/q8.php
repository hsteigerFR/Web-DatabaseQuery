...
$sql='SELECT * FROM Patient WHERE NumPat NOT IN (SELECT DISTINCT NumPat FROM Hospitalisation WHERE DateSortie > DATE_ADD(DateEntree, INTERVAL 2 WEEK))';
